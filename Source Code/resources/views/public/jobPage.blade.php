...
<meta name="keywords" content="Qorrah, Job, {{$position->name}} , Training">
@endsection
@section('content')
					...
					<div class="left-side">
						...
						<div class="header-details">
							...
							<ul>
								...
								@if ($position->city)
								<li><i class="icon-material-outline-location-on"></i> {{$position->city}} {{$position->address ? ',' : null}} {{$position->address}}</li>
								@else
								<li><i class="icon-material-outline-location-on"></i> {{$company->city}} {{$company->address ? ',' : null}} {{$company->address}}</li>
								@endif
					...
					<a href="{{ route('job', ['id'=>$similar->position_id]) }}" class="job-listing">
						...
						<div class="job-listing-footer">
							<ul>
								...
								@if ( ($date = (strtotime(date("Y-m-d")) - strtotime(explode(" " , $similar->created_at)[0]))) < 60*60*24 ) <li><i class="icon-material-outline-access-time"></i> {{'today'}} </li>
									@else
						...
						<div class="job-overview-inner">
							<ul>
								...
								<li>
									...
									@if ( ($date = (strtotime(date("Y-m-d")) - strtotime(explode(" " , $position->created_at)[0]))) < 60*60*24 ) <h5>{{'today'}}</h5>
										@else
