...
@section("title")
<title>Qorrah | compare majors</title>
...
<div class="full-page-container">
	...
	<div class="full-page-sidebar">
		...
		<div class="sidebar-widget">
			...
			<input type="text" class="margin-left-5 margin-right-5 nameSearch" placeholder="english">
		</div>
		</div>
		</div>
	</div>
	...
	<div class="full-page-content-container" data-simplebar>
		...
		<div class="full-page-content-inner">
			<div class="listings-container grid-layout margin-top-35">
				@foreach ($vs_majors as $vsMajor)
				<!-- vsMajor Listing -->
				<a href={{ url('compare_majors/'. $vsMajor->vsMajor_id ) }} class="job-listing element">

					<!-- Job Listing Details -->
					<div class="job-listing-details" >
						<!-- Logo -->
						<div class="background-image-container">								
							<img class='majors-major-image' src={{asset("assets/images/profile/$vsMajor->image")}} alt="{{$vsMajor->name}}">
						</div>
					</div>
				<!-- Job Listing Footer -->
				<div class="job-listing-footer">
					
						<h4 class='majorName'><i class="icon-line-awesome-balance-scale"></i> {{$vsMajor->name}}</h4>
					
				</div>					
				</a>
                @endforeach

				@if (count($vs_majors) <1)
									<!-- Job Listing -->
