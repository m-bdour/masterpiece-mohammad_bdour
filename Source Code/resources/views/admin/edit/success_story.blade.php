...
@section("title")
    <title>Qorrah | Edit success story</title>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-feather-folder-plus"></i> success story edit Form</h3>
						</div>
					
					<form id="addUser" action="/admin/success_story/{{$sstory->sstory_id }}/update" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						@method('PATCH')
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>name</h5>
										<input type="text" class="with-border" name="name" value="{{$sstory->name}}" required>
										@if ($errors->has('name'))
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>English name</h5>
										<input type="text" class="with-border" name="Ename" value="{{$sstory->Ename}}">
										@if ($errors->has('Ename'))
							...
							<div class=" col-xl-4 addImage">
								<div id="profile" class="image " style="background-image: url({{asset("assets/images/profile/$sstory->image")}})" >
							...
							{{-- cover Image --}}
							<div class=" col-xl-4 addImage">
								<div id="cover" class="image " style="background-image: url({{asset("assets/images/profile/$sstory->cover")}})" >
								<div class="dashes"></div>
								<label style="color: #fff ; text-shadow : 0 0 3px #333">Change</label>
								</div>
								<p>Cover image</p>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<input type="text" class="with-border" name="title" value="{{$sstory->title}}">
										@if ($errors->has('title'))
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="keywords-container">
											...
											<p class="hiddenValue hiddenElement" id="skills"> {{$sstory->keywords}} </p>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										<h5>about</h5>
										<textarea name="about" class="tinymce">{{$sstory->about}}</textarea>
									</div>
								</div>															
