...
@section("title")
    <title>Qorrah | Edit university</title>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-feather-folder-plus"></i> university edit Form</h3>
						</div>
					
					<form id="addUser" action="/admin/university/{{$university->university_id }}/update" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						@method('PATCH')
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<input type="text" class="with-border" name="name" value="{{$university->name}}" required>
										@if ($errors->has('name'))
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>English name</h5>
										<input type="text" class="with-border" name="Ename" value="{{$university->Ename}}">
										@if ($errors->has('Ename'))
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5> Majors</h5>
										<select class="selectpicker with-border" id="majorSelect" data-live-search="true" name="majors[]" id="majors" data-size="4" multiple>
											<option disabled value='select major'>select multi majors</option>
											@foreach($majors as $major)
											@if ( in_array($major->major_id, $majorsArr) )
												
											<option selected class="batata" value="{{$major->major_id}}">{{$major->major}}
											</option>
											@else
							...
							<div class=" col-xl-4 addImage">
								<div id="profile" class="image " style="background-image: url({{asset("assets/images/profile/$university->image")}})" >
							...
							{{-- cover Image --}}
							<div class=" col-xl-4 addImage">
								<div id="cover" class="image " style="background-image: url({{asset("assets/images/profile/$university->cover")}})" >
								<div class="dashes"></div>
								<label style="color: #fff ; text-shadow : 0 0 3px #333">Change</label>
								</div>
								<p>Cover image</p>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<input type="text" class="with-border" name="title" value="{{$university->title}}">
										@if ($errors->has('title'))
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="keywords-container">
											...
											<p class="hiddenValue hiddenElement" id="skills"> {{$university->keywords}} </p>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										<h5>about</h5>
										<textarea name="about" class="tinymce">{{$university->about}}</textarea>
									</div>
								</div>															
