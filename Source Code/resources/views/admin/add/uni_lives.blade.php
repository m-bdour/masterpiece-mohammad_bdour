...
@section("title")
<title>Qorrah | Add University life</title>
		...
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="dashboard-box margin-top-0">
					<!-- Headline -->
					<div class="headline">
						<h3><i class="icon-feather-folder-plus"></i> University life Submission Form</h3>
					</div>

					<form id="addUser" action="/admin/uni_live" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<input type="text" class="with-border" name="link" value="{{ old('link') }}">
										@if ($errors->has('link'))
