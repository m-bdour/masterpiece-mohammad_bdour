...
@section("title")
<title>Qorrah | Add Success story</title>
		...
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="dashboard-box margin-top-0">
					<!-- Headline -->
					<div class="headline">
						<h3><i class="icon-feather-folder-plus"></i> Success story Submission Form</h3>
					</div>

					<form id="addUser" action="/admin/success_story" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>story major</h5>
										<select class="selectpicker with-border" id="majorSelect" data-live-search="true" name="major_id" data-size="4" value="{{ old('major_id') }}" title="Select story major">
