...
@section("title")
<title>Qorrah | Add article</title>
		...
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="dashboard-box margin-top-0">
					<!-- Headline -->
					<div class="headline">
						<h3><i class="icon-feather-folder-plus"></i> article Submission Form</h3>
					</div>

					<form id="addUser" action="/admin/article" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
